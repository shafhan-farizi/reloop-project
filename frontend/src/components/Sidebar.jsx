...
export default function Sidebar({ open, onClose }) {
  ...
  return (
    <>
      ...
      <aside className={`fixed inset-y-0 left-0 z-40 w-72 transform border-r border-slate-200 bg-white px-5 py-6 shadow-xl transition duration-300 lg:static lg:translate-x-0 ${
        open ? 'translate-x-0' : '-translate-x-full'
      }`}>
        <div className="mb-8 flex items-center justify-between lg:hidden">
          <div>
            <div className="text-2xl font-semibold text-slate-900">ReLoop Admin</div>
