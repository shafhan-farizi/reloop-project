...
const mainNav = [
  { label: 'Beranda', icon: HomeIcon, to: '/penerima' },
  { label: 'Cari Barang', icon: MagnifyingGlassIcon, to: '/penerima/cari' },
  { label: 'Request Saya', icon: ClipboardDocumentListIcon, to: '/penerima/request-saya' },
  { label: 'Tracking', icon: TruckIcon, to: '/penerima/tracking' },
  { label: 'Riwayat', icon: ClockIcon, to: '/penerima/riwayat' },
];

const secondaryNav = [
  { label: 'Notifikasi', icon: BellIcon, to: '/penerima/notifikasi' },
  { label: 'Profile', icon: UserCircleIcon, to: '/penerima/profile' },
  { label: 'Pengaturan', icon: Cog6ToothIcon, to: '/penerima/pengaturan' },
      ...
      <aside className={`fixed inset-y-0 left-0 z-40 w-72 transform flex flex-col bg-teal-700 px-6 py-8 shadow-2xl transition duration-300 lg:static lg:translate-x-0 ${
        ...
        <div className="mb-8 flex items-center justify-between lg:hidden">
          <div>
            ...
            <p className="text-sm text-teal-100">Kelola kebutuhanmu.</p>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="hidden lg:block mb-10">
          ...
          <p className="text-sm text-teal-100">Kelola kebutuhan dan tracking dengan mudah.</p>
        </div>
