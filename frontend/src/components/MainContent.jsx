...
{/* HERO */}
<div className="relative overflow-hidden rounded-3xl bg-orange-500 p-8 shadow-xl">  {/* Background Decoration */}
  ...
  <div className="relative z-10 flex flex-col gap-8 lg:flex-row lg:items-center lg:justify-between">
    ...
    <div>
      ...
      <p className="mt-3 max-w-xl text-orange-50">
        Kelola pengguna, donasi, permintaan barang, dan pengiriman
