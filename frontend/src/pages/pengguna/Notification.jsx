        ...
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <button
              ...
              disabled={loading || meta.unread_count === 0}
              className="rounded-full border border-slate-200 bg-[#14B8A6] px-5 py-3 text-sm font-semibold text-white hover:bg-[#0f766e] disabled:cursor-not-allowed disabled:opacity-50"
            >
              Tandai Semua Dibaca
            </button>
          </div>
