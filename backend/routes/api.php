...
// ✅ untuk api yang sudah dicek di postman
// ❌ untuk api yang mungkin tidak digunakan
...
// user profile publik
Route::get('/users/{username}/profile',   [UserController::class, 'publicProfile']); // ✅
...
Route::middleware(['auth:sanctum', 'active'])->group(function () {
    ...
    Route::get('/auth/me', [AuthController::class, 'me']); // ❌ tidak dipakai karena sudah ada dan lebih bagus di profiles>get
